...
## Step 1. Develop AI Data Processing Job
...
2. Click the **+** icon above the job list to create a stream processing job. Enter the name and description of the job and select *Window Aggregation for AI* as the template. Optionally, you can choose to import the configuration file of an existing stream to complete the configuration quickly.
...
When the stream processing configuration is completed, you can save and publish the AI data aggregation job online.
