...
For information about device connection and data ingestion, see [Device Connection](https://docs.eniot.io/docs/device-connection/en/latest/quickstart/gettingstarted_device_connection.html).
